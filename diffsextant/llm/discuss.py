...
def bundle_path_for(cwd: Path, ref1: str, ref2: str) -> Path:
    ...
    from diffsextant.cache import storage_dir
    sid = _session_id(cwd, ref1, ref2)
    return (storage_dir(cwd) / "conversations" / sid).resolve()
...
def build_discuss_bundle(result, ref1: str, ref2: str,
    ...
    sid = _session_id(cwd, ref1, ref2)
    bundle_dir = (storage_dir(cwd) / "conversations" / sid).resolve()
...
def discuss(ref1: str, ref2: str,
    ...
    if classify is None:
        from diffsextant.tree_delta import classify_diff as _classify
        classify = _classify
    ...
    if agent == "stdout" or chosen == "stdout":
        ...
        from diffsextant.llm.runner import copy_to_clipboard

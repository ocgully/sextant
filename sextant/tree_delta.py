...
from sextant.git_context import GitContext, collect as collect_git_context
...
def _per_file_classifiers() -> List[Classifier]:
    ...
    """
    from sextant.ops.malformed import MalformedClassifier
    ...
    from sextant.ops.reformat import LintFixClassifier, ReformatClassifier
...
def classify_diff(ref1: str, ref2: str, cwd: Optional[Path] = None,
    ...
    from sextant.ops.move import detect_move_symbols
